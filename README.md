...
*preemptible = true - создает прерываемую виртуальную машину, это снижает стоимость аренды ВМ, ее можно использовать, если Вам не нужен постоянная доступность машины и ресурсы при нехватке могут быть отданы другим ресурсам.*

*core_fraction=5, определяет, какую часть физического ядра гарантированно получит ваша ВМ ~ 5%.*
...
### Решение 2
Ссылка на файл variables.tf: [variables.tf](https://github.com/pythonyandex/Terraform_L2/blob/main/Task2_variables.tf)
